    ...
    public class Reconcile : BaseAction
    {
        ...
        override public int run(ref PlatformOutput platformOutput)
        {
            ...
            try
            {
                ...
                // Execute Reset Password Process as Reconcile User
                var executeReconcileResponse = reconcileClient.ResetUserPassword(reconcileResponse.Result.Result.Uuid, newPassword);
                ResponseAPI.ValidateActionResponse(executeReconcileResponse);
                if (executeReconcileResponse.Result.Success)
                {
