namespace CyberArk.Extensions.Identity
{
    ...
    public static class PluginErrors
    {
        ...
        public static readonly int RESPONSE_CONTENT_NULL = 8810;
        ...
        public static readonly int SUCCESS_USER_NOT_AUTHORIZED = 8853;
        public static readonly int SUCCESS_SERVICE_NOT_AUTHORIZED = 8854;
        public static readonly int SUCCESS_INVALID_PASSWORD_COMPLEXITY = 8855;
        public static readonly int SUCCESS_PASSWORD_SAME_AS_OLD = 8856;
        public static readonly int SUCCESS_PASSWORD_LAST_N = 8857;
        public static readonly int SUCCESS_JSON_EXCEPTION = 8858;
